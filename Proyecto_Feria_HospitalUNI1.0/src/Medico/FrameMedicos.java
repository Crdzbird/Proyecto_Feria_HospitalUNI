...
import static Validaciones.CentrarInternal.Centrar;
...
//        llenartabla();
     ...
     */
    public BufferedImage bufferedMedicoImagen;
    SessionFactory sf;
...
//    }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblImagen, javax.swing.GroupLayout.DEFAULT_SIZE, 292, Short.MAX_VALUE)
        );
    ...
    public void ValidarImagenes() {
        ...
        if (lblImagen != null) {
            ...
            try {
                ImageIO.write(bufferedMedicoImagen, "jpg", os);
                os.flush();
...
//        bufferedMedicoImagen = this.abrirImagen();
//        procesamientoImagenes pi = new procesamientoImagenes();
//        int height = lblImagen.getHeight();
//        int width = lblImagen.getWidth();
//        lblImagen.setIcon((pi.imageToIcon(pi.imageToBufferedImage(bufferedMedicoImagen).getScaledInstance(width, height, 0))));
...
//                            procesamientoImagenes pi = new procesamientoImagenes();
//                            this.bufferedMedicoImagen = imag;
...
//        int height = lblImagen.getHeight();
//        int width = lblImagen.getWidth();
//        lblImagen.setIcon((renderImagen.imageToIcon(renderImagen.imageToBufferedImage(bufferedMedicoImagen).getScaledInstance(width, height, 0))));
//        lblImagen.setText(null);
